// ====== CONFIG ======
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxwEc2kAoiL7wTKsic-0r1JYNpphQkq9myxr-QZcwDp-V_hmmAzUkVPFvbzfpb63khk/exec';
...
async function onSubmit(e) {
  ...
  let minutes = endMins - startMins - breakMins;
  ...
  try {
    const res = await fetch(SCRIPT_URL, {
      method: 'POST',
      // no headers -> text/plain, avoids CORS preflight
